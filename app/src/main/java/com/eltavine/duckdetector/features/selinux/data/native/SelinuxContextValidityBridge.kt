...
open class SelinuxContextValidityBridge {
    ...
    private fun SelinuxContextValiditySnapshot.applyEntry(
        key: String,
        value: String,
    ): SelinuxContextValiditySnapshot = when (key) {
    ...
    companion object {
        ...
        @JvmStatic
        fun nativeCollectContextValiditySnapshot(): String = SelinuxContextValidityBridge().nativeCollectContextValiditySnapshotInternal()
        ...
        @JvmStatic
        internal fun consumePreloadedRawDataForCarrier(): String? = consumePreloadedRawData()
