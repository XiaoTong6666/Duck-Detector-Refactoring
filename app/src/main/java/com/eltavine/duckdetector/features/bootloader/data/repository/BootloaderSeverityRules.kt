...
internal object BootloaderSeverityRules {
    ...
    fun trustRootSeverity(trust: CertificateTrustResult): BootloaderFindingSeverity = when {
    ...
    fun isKeyPairGenerationFailure(errorMessage: String?): Boolean = errorMessage?.contains("generate a key pair", ignoreCase = true) == true
}
