...
class DangerousAppsCardModelMapper {
    ...
    ): DangerousAppsCardModel = DangerousAppsCardModel(
    ...
    private fun buildVerdict(report: DangerousAppsReport): String = when (report.stage) {
    ...
    private fun buildSummary(report: DangerousAppsReport): String = when (report.stage) {
    ...
    private fun buildHeaderFacts(report: DangerousAppsReport): List<DangerousAppsHeaderFactModel> = listOf(
    ...
    private fun buildPackageItems(report: DangerousAppsReport): List<DangerousAppsPackageItemModel> = when (report.stage) {
        DangerousAppsStage.LOADING,
        DangerousAppsStage.FAILED,
        -> emptyList()

        DangerousAppsStage.READY ->
            report.findings
                .sortedWith(
    ...
    private fun visibilityLabel(visibility: DangerousPackageVisibility): String = when (visibility) {
    ...
    private fun visibilityLongLabel(visibility: DangerousPackageVisibility): String = when (visibility) {
    ...
    private fun DangerousAppsReport.toDetectorStatus(): DetectorStatus = when (stage) {
