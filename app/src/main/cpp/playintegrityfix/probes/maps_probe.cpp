...
std::vector<RuntimeTrace> scan_runtime_maps() {
    ...
    while (std::fgets(line, sizeof(line), fp) != nullptr) {
        ...
        const bool pif_named =
            contains_any(lowered, {"playintegrity", "integrityfix", "pihooks", "pixelprops"});
        ...
        trace.severity = (keystore_associated || deleted_loader) ? TraceSeverity::kDanger
